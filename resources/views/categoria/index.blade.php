    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card shadow-sm border-0 animate__animated animate__fadeIn">
                ...
                <div class="card-header bg-light text-primary d-flex justify-content-between align-items-center border-bottom border-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-4 animate__animated animate__fadeInLeft">
                        ...
                        <button class="btn btn-light btn-sm fw-bold d-flex align-items-center shadow-sm 

                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                ...
                                                @if ($venta->comprobante->tipo === 'boleta')
                                                    <a href="{{ route('ventas.descargarBoleta', $venta->id) }}"
                                                        class="btn btn-outline-success btn-sm shadow-sm">
                                                        <i class="fas fa-download"></i> Descargar Boleta
                                                    </a>
                                                @elseif($venta->comprobante->tipo === 'factura')
                                                    <a href="{{ route('ventas.descargarFactura', $venta->id) }}"
                                                ...
                                                <button class="btn btn-outline-danger btn-sm shadow-sm"
                                                    ...
                                                    data-bs-target="#modalEliminar-{{ $venta->id }}">

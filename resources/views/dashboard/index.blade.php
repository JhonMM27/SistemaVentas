    ...
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 80vh;">
        <div class="row justify-content-center animate__animated animate__fadeIn">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-4">
                <div class="small-box bg-gradient shadow rounded-4 border-0 p-4 text-center animate__animated animate__fadeInUp" style="background-color: #f28b82;">
                    ...
                    <a href="{{ route('ventas.index') }}" class="btn btn-light btn-lg mt-3 w-75 animate__animated animate__pulse animate__infinite">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-4">
                <div class="small-box bg-gradient shadow rounded-4 border-0 p-4 text-center animate__animated animate__fadeInUp animate__delay-1s" style="background-color: #90caf9;">
                    <div class="inner text-center">
                    ...
                    <a href="{{ route('categorias.index') }}" class="btn btn-light btn-lg mt-3 w-75 animate__animated animate__pulse animate__infinite">
                        Ir <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            ...
            <!-- Productos -->
            <div class="col-lg-4 col-md-6 col-12 mb-4">
                <div class="small-box bg-gradient shadow rounded-4 border-0 p-4 text-center animate__animated animate__fadeInUp animate__delay-2s" style="background-color: #a5d6a7;">
                    <div class="inner text-center">
                    ...
                    <a href="{{ route('productos.index') }}" class="btn btn-light btn-lg mt-3 w-75 animate__animated animate__pulse animate__infinite">
                        Ir <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            ...
            <!-- Usuarios -->
            <div class="col-lg-4 col-md-6 col-12 mb-4">
                <div class="small-box bg-gradient shadow rounded-4 border-0 p-4 text-center animate__animated animate__fadeInUp animate__delay-3s" style="background-color: #ffcc80;">
                    <div class="inner text-center">
                    ...
                    <a href="{{ route('usuarios.index') }}" class="btn btn-light btn-lg mt-3 w-75 animate__animated animate__pulse animate__infinite">
                        Ir <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            ...
            <!-- Reportes -->
            <div class="col-lg-4 col-md-6 col-12 mb-4">
                <div class="small-box bg-gradient shadow rounded-4 border-0 p-4 text-center animate__animated animate__fadeInUp animate__delay-4s" style="background-color: #b0bec5;">
                    <div class="inner text-center">
                    ...
                    <a href="{{ route('reportes.index') }}" class="btn btn-light btn-lg mt-3 w-75 animate__animated animate__pulse animate__infinite">
                        Ir <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>

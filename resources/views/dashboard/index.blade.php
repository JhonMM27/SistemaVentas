    ...
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 80vh;">
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 col-12 mb-3">
                <div class="small-box bg-gradient" style="background-color: #f28b82; padding: 20px;">
                    ...
                    <a href="{{route('ventas.index')}}" class="small-box-footer btn mt-2">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-3">
                <div class="small-box bg-gradient" style="background-color: #90caf9; padding: 20px;">
                    <div class="inner text-center">
                        <h2>Categorías</h2>
                    ...
                    <a href="{{ route('categorias.index') }}" class="small-box-footer btn mt-2">
                        Más info <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-3">
                <div class="small-box bg-gradient" style="background-color: #a5d6a7; padding: 20px;">
                    <div class="inner text-center">
                        <h2>Productos</h2>
                    ...
                    <a href="{{ route('productos.index') }}" class="small-box-footer btn mt-2">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-3">
                <div class="small-box bg-gradient" style="background-color: #ffcc80; padding: 20px;">
                    <div class="inner text-center">
                        <h2>Usuarios</h2>
                    ...
                    <a href="{{route('usuarios.index')}}" class="small-box-footer btn mt-2">
                        IR <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-3">
                <div class="small-box bg-gradient" style="background-color: #b0bec5; padding: 20px;">
                    <div class="inner text-center">
                        <h2>Reportes</h2>
                    ...
                    <a href="#" class="small-box-footer btn mt-2">
                        Más info <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
